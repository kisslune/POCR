...
const u32_t Options::timeOut = 24 * 3600;     // in second

const llvm::cl::opt<bool> Options::solveCFL(
        "solve",
        llvm::cl::init(true),
        llvm::cl::desc("solve CFL-reachability")
);

const llvm::cl::opt<bool> Options::writeGraph(
        "write-graph",
        llvm::cl::init(false),
        llvm::cl::desc("solve CFL-reachability")
);

const llvm::cl::opt<bool> Options::graphStat(
        "graph-stat",
        llvm::cl::init(false),
